...
public class DietitianUpdateProfileActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_dietitian_update_profile);
    ...
    private View.OnClickListener onUpdateListener()
    {
        return v ->
        {
            ...
            {
                Toast.makeText(DietitianUpdateProfileActivity.this,
    ...
    private OnCompleteListener<Uri> onCompleteUploadListener()
    {
        return task ->
        {
            ...
            if (task.isSuccessful())
            {
                ...
                // update the children
                databaseReferenceBusinessProfile.updateChildren(updates)
    ...
    private OnCompleteListener<Void> onCompleteListener()
    {
        return task ->
        {
            ...
            intent = new Intent(DietitianUpdateProfileActivity.this,
                    DietitianMainMenuActivity.class);
