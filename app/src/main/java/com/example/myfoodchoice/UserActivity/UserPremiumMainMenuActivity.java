...
public class UserPremiumMainMenuActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    // fixme: after user is already in Account Type as "Premium Account" in Firebase.
    ...
    final static String TAG = "UserPremiumMainMenuActivity";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_user_premium_main_menu);
    ...
    private ValueEventListener valueUserProfileEventListener()
    {
        return new ValueEventListener()
        {
            ...
            {
                Toast.makeText
                        (UserPremiumMainMenuActivity.this, "Error database connection", Toast.LENGTH_SHORT).show();
